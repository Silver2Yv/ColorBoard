...
一个基于 Web 的交互式调色盘工具，支持 RGB、HSV、HSL 三种色彩空间，提供 2D 和 3D 两种可视化模式，主要用于理解三种色彩空间，以及通过3D模型来建立对色彩空间的直观生动几何理解。
...
## 效果预览
![2D模式](readme_pictures/2D.png)

![3D模式](readme_pictures/3D.png)
